...
const PROFILE_QUERY = `*[
  _type == "profile" && slug.current == 'umroo'][0]`;

const BUTTONS_QUERY = `*[_type== "buttons"] | order(order asc)`
      ...
      <div className="relative z-10 min-h-screen flex justify-center items-start py-20 px-4 bg-black/50">
        ...
        <div className="w-full max-w-xl rounded-2xl text-white">
          <div className='flex justify-between'>
            <Button className='w-10 h-10 rounded-full bg-black/40'><FaRegBell /></Button>
            <TriggerDialog
